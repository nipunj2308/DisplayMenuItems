...
public class RecyclerViewForSalesSummary extends RecyclerView.Adapter<RecyclerViewForSalesSummary.ViewHolder> {
    ...
    public RecyclerViewForSalesSummary(ArrayList<ModelClassForSalesAndOrderSummary> OrderDatesList)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.sales_summary_recyclerview_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            if (OrderDatesList.get(position).getDate().equals("Monthly Summary"))
            {
                ...
                String query = "Select SUM("+sqliteHelper.TotalSale +") from " + sqliteHelper.TABLE_NAME3 + ";";
                Cursor cursor = sqLiteDatabase.rawQuery(query, null);
                if (cursor != null)
                {
                    while (cursor.moveToNext()) {
                        Double TotalSale = cursor.getDouble(0);
                        BigDecimal bd = new BigDecimal(TotalSale).setScale(2, RoundingMode.UP);
                        Double FormattedTotalSale = bd.doubleValue();
                        holder.TotalSaleTextView.setText("Total Sale :"+String.valueOf(FormattedTotalSale));
                ...
                String query = "Select "+sqliteHelper.TotalSale +" from " + sqliteHelper.TABLE_NAME3 + ";";
                ...
                if (cursor != null)
                {
                    ...
                    {
                        double TotalSale = cursor.getDouble(0);
                        holder.TotalSaleTextView.setText("Total Sale :" +String.valueOf(TotalSale));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
   {
       ...
       public ViewHolder(@NonNull View itemView) {
           ...
           viewDetailsOfCurrentDate = itemView.findViewById(R.id.ViewDetailsForCurrentDateButton);
           TotalSaleTextView = itemView.findViewById(R.id.TotalSaleTextView);
           ...
           viewDetailsOfCurrentDate.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View view)
               {
                   Intent intent = new Intent(context, FullSalesDetails.class);
